...
- `tool/validate_agent_workflow.py`: instruction links, README current-status ownership and workflow graph/trigger invariants (requires Python 3.11+ and PyYAML in the developer environment).
