...
| Android 最新本机构建/原生输入 | 现存 `b79e8838` arm64 Debug，3.1.8+4121 / Manifest 6121，289007467 B，SHA-256 `377D4CD5…30ED`；16 个原生库、最小 ELF LOAD `0x4000`、APK 内容门禁通过。该包早于当前源码 `1e4f566e`，未覆盖安装，也不作为新增平台、布局修复、斗鱼会话、各平台搜索入口、工具箱链接预检、TwitCasting 精确频道链接或 Rumble HLS 修复的原生证据 |
