...
| 项目 | 当前证据 |
| --- | --- |
| 功能源码基线 | `a8449029` 已推送。猫耳 FM 官网直播关键词分页现进入应用搜索，含未开播房间；Focused **116/116**、全库 Analyze 无诊断，注册适配器生产搜索 **1/1**，见[专项记录](MISSEVAN_NATIVE_KEYWORD_SEARCH_AUDIT_2026_09_23.md)。近期外部打开和网页搜索修订见[房间目标](ROOM_EXTERNAL_OPEN_COVERAGE_AUDIT_2026_09_23.md)、[链接回流](WEB_SEARCH_XHS_TTING_LINK_AUDIT_2026_09_23.md)、[导航归属](WEB_SEARCH_NAVIGATION_OWNERSHIP_AUDIT_2026_09_23.md)。最近一次完整门禁仍绑定 `b79e8838`：Flutter **4999/4999**、公共接口 **42/42**，记录 `20260919T181710597Z-quality-full.json`；下个候选前需重跑 Full |
| Android 最新本机构建/原生输入 | 现存 `b79e8838` arm64 Debug，3.1.8+4121 / Manifest 6121，289007467 B，SHA-256 `377D4CD5…30ED`；16 个原生库、最小 ELF LOAD `0x4000`、APK 内容门禁通过。该包早于当前源码 `a8449029`，未覆盖安装；新增平台、搜索、布局及录制等后续修订均待新候选原生验收 |
