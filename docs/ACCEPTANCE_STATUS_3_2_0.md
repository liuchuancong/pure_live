...
| 项目 | 当前证据 |
| --- | --- |
| 功能源码基线 | 当前源码 `0050b364`；最近一次干净输入 `68723042` 通过[完整门禁](FULL_GATE_DEBUG_CANDIDATES_2026_09_24.md)：Flutter **5310/5310**、公共接口 **42/42**、全仓 Analyze 无问题，记录 `20260923T173235870Z-quality-full.json`。之后首选平台可见性修订三文件 **19/19**、弹窗名称/ID 过滤 Widget **7/7**；小红书官方直播深链仅导入房间身份，首轮应用+分享 **91/91**、最终分享 **65/65**，两轮全仓 Analyze 无问题（最终记录 `20260923T180822098Z-quality-focused.json`）。新增源码仍待新 Full、双端构建及 GUI/媒体/长时原生验收 |
