...
| 平台范围 | 当前源码 **33 个直播站点 + IPTV，共 34 个适配器**；PandaTV、PopkonTV、Shopee Live 与 VK Video Live 已完成首阶段源码接入，战旗与浪 Live 保持内部 readiness，DLive、一直播与企鹅电竞已归档生命周期证据；已注册平台仍有能力与双端原生覆盖缺口 |
...
5. **平台扩展继续推进**：战旗与浪 Live 等待当前生产媒体证据后注册；DLive、一直播与企鹅电竞已完成生命周期归档；PandaTV、PopkonTV、Shopee Live 与 VK Video Live 已进入源码能力表，双端原生与录制证据并入集中验收。
