...
| ID | 状态 | 验收内容 |
|---|---|---|
| A6-01 | RUN | Bilibili 显示 35 秒/2.75 MB/1.1x；虎牙显示 40 秒/19.00 MB/1.2x/4.2 Mbps；斗鱼显示 39 秒/88.25 MB/1.2x/29.4 Mbps，三个样本均有私有 TS 增长。开始前目录探测和准备态继续补证 |
| A6-02 | RUN | Bilibili、虎牙、斗鱼的停止、封装、已停止状态和取消监控通过；失败重连、待开播、离线恢复、分组及滚动边界继续执行 |
| A6-03 | RUN | Bilibili 7,763,631 B / 60.086333 秒；虎牙 27,681,159 B / 56.813667 秒、1440p120；斗鱼修复后 140,249,937 B / 61.416867 秒、2160p；三者均为 H.264 + AAC。其他平台继续执行 |
| A6-04 | RUN | Bilibili、虎牙、斗鱼样本停止后监控均移除，强制停止后进程消失且活动 Wake Lock 无 Pure Live；签名/线路过期续接、跨分片累计与正常退出资源释放继续执行 |
