...
快照时间为 2026-09-01（Asia/Shanghai）：维护仓库当前没有未关闭 Issue；上游未关闭列表共 10 项，编号为 #828、#827、#825、#824、#821、#819、#792、#779、#767、#708，最新项为 #828。#801、#807、#810、#817、#818、#820、#823、#826 已由上游关闭；关闭状态只表示 Issue 生命周期变化，不替代本维护分支的代码与运行验证。下表覆盖全部当前未关闭上游 Issue，并保留与维护分支直接相关的已关闭项、闭环或后续设计记录。
