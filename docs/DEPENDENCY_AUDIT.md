...
- FFmpeg Kit Extended Flutter 0.6.2；应用通过平台资产覆盖采用已验证的 FFmpeg 9.0.2 Android/Windows/Linux/macOS 原生包，并复用经过 SHA-256 校验的 Android/Windows Native Assets 共享缓存。iOS 原生包仍在构建和验证；macOS 应用构建验证待完成。
