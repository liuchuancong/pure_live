...
class AppTextStyles {
  ...
  static SettingsService get _settings => Get.find<SettingsService>();

  // 🌟 1. 微型辅助文本 (Body Small)
  static TextStyle get t11 =>
      (_base.bodySmall ?? const TextStyle()).copyWith(fontSize: _settings.fontSizeBodySmall.value);
  ...
  static TextStyle get t13 =>
      (_base.bodyMedium ?? const TextStyle()).copyWith(fontSize: _settings.fontSizeBodyMedium.value);
  ...
  static TextStyle get t14 =>
      (_base.bodyLarge ?? const TextStyle()).copyWith(fontSize: _settings.fontSizeBodyLarge.value);
  ...
  static TextStyle get t15 =>
      (_base.titleMedium ?? const TextStyle()).copyWith(fontSize: _settings.fontSizeTitleMedium.value);
  ...
  static TextStyle get t18 =>
      (_base.titleLarge ?? const TextStyle()).copyWith(fontSize: _settings.fontSizeTitleLarge.value);
  ...
  static TextStyle get t24Bold => (_base.headlineSmall ?? const TextStyle()).copyWith(
    fontSize: (_settings.fontSizeTitleLarge.value * 1.2),
    fontWeight: FontWeight.w700,
  );
  static TextStyle get t32Bold => (_base.headlineLarge ?? const TextStyle()).copyWith(
    fontSize: (_settings.fontSizeTitleLarge.value * 1.6),
