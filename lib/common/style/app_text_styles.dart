...
class AppTextStyles {
  ...
  static TextStyle get t11 => (_base.bodySmall ?? const TextStyle()).copyWith(fontSize: 11);
  ...
  static TextStyle get t12 => (_base.bodySmall ?? const TextStyle()).copyWith(fontSize: 12);
  ...
  static TextStyle get t13 => (_base.bodyMedium ?? const TextStyle()).copyWith(fontSize: 13);
  ...
  static TextStyle get t14 => (_base.bodyLarge ?? const TextStyle()).copyWith(fontSize: 14);
  ...
  static TextStyle get t15 => (_base.titleMedium ?? const TextStyle()).copyWith(fontSize: 15);
  ...
  static TextStyle get t16 => (_base.titleMedium ?? const TextStyle()).copyWith(fontSize: 16);
  ...
  static TextStyle get t18 => (_base.titleLarge ?? const TextStyle()).copyWith(fontSize: 18);
  ...
  static TextStyle get t20 => (_base.titleLarge ?? const TextStyle()).copyWith(fontSize: 20);
  ...
  static TextStyle get t24Bold =>
      (_base.headlineSmall ?? const TextStyle()).copyWith(fontSize: 24, fontWeight: FontWeight.w700);
  static TextStyle get t32Bold =>
      (_base.headlineLarge ?? const TextStyle()).copyWith(fontSize: 32, fontWeight: FontWeight.w800);
}
