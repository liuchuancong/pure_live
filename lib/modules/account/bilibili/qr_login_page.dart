      ...
      body: Column(
        ...
        children: [
              ...
              if (controller.qrStatus.value == QRStatus.failed) {
                return Column(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: controller.loadQRCode, child: Text(i18n("retry"))),
                  ],
                );
              }
              ...
              if (controller.qrStatus.value == QRStatus.failed) {
                return Column(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: controller.loadQRCode, child: Text(i18n("refresh_qr"))),
                  ],
                );
              }
          ...
          Padding(
            ...
            child: Text(i18n("qr_login_tip"), textAlign: TextAlign.center),
          ),
        ],
      ),
    );
