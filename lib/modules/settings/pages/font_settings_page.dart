          ...
          children: [
            ...
            context.buildModernCard([
              ...
              context.buildSliderTile(
                ...
                max: 17.0,
                displayValue:
                    '${SettingsService.to.font.fontSizeBodyMedium.v.toStringAsFixed(0)}px',
                onChanged: (newValue) {
            ...
            context.buildModernCard([
              context.buildSliderTile(
                ...
                max: 20.0,
                displayValue:
                    '${SettingsService.to.font.fontSizeTitleMedium.v.toStringAsFixed(0)}px',
                onChanged: (newValue) {
              ...
              context.buildSliderTile(
                ...
                max: 26.0,
                displayValue:
                    '${SettingsService.to.font.fontSizeTitleLarge.v.toStringAsFixed(0)}px',
                onChanged: (newValue) {
