    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          spacer(16),
          ElevatedButton(
            child: Text(i18n('supabase_update_password'), style: const TextStyle(fontWeight: FontWeight.bold)),
            onPressed: () async {
              ...
              try {
                ...
                if (widget.onError == null) {
                  context.showErrorSnackBar(i18n('supabase_unexpected_err', args: {'error': error.toString()}));
                } else {
                  widget.onError?.call(error);
                }
              }
