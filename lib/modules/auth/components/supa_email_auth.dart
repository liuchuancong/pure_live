        ...
        children: [
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              label: Text(i18n('supabase_enter_email')),
            ),
          ...
          if (!_forgotPassword) ...[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                label: Text(i18n('supabase_enter_password')),
              ),
              obscureText: true,
            ...
            ElevatedButton(
              child: (_isLoading)
                  ...
                  : Text(_isSigningIn ? i18n('supabase_sign_in') : i18n('supabase_sign_up')),
              onPressed: () async {
                ...
                try {
                  ...
                  if (widget.onError == null) {
                    context.showErrorSnackBar(i18n('supabase_unexpected_err',args: {
          ...
          if (_isSigningIn && _forgotPassword && Platform.isAndroid) ...[
            ...
            ElevatedButton(
              ...
              child: Text(i18n('supabase_reset_password')),
            ),
            spacer(16),
            TextButton(
              onPressed: () {
