...
class PlayerConsts {
  ...
  static String getKeyByI18nKey(String i18nKey) {
    return names.entries
        .firstWhere((e) => e.value == i18nKey, orElse: () => names.entries.first)
        .key;
  }
  ...
  static const List<Map<String, String>> hardwareDecodersList = [
    ...
    {
      'key': 'videotoolbox',
      'nameEn': 'VideoToolbox (macOS / iOS)',
      'nameZh': 'VideoToolbox（macOS / iOS）',
    },
    {
      'key': 'videotoolbox-copy',
      'nameEn': 'VideoToolbox (Copy-Back)',
      'nameZh': 'VideoToolbox（非直通）',
    },
    ...
    {
      'key': 'nvdec-copy',
      'nameEn': 'NVDEC (NVIDIA Only, Copy-Back)',
      'nameZh': 'NVDEC（仅 NVIDIA，非直通）',
    },
    ...
    {
      'key': 'vulkan-copy',
      'nameEn': 'Vulkan (Experimental, Copy-Back)',
      'nameZh': 'Vulkan（全平台，实验性，非直通）',
    },
    ...
    {
      'key': 'mediacodec-copy',
      'nameEn': 'MediaCodec (Copy-Back)',
      'nameZh': 'MediaCodec（Android，非直通）',
    },
    {'key': 'cuda', 'nameEn': 'CUDA (NVIDIA Only, Deprecated)', 'nameZh': 'CUDA（仅 NVIDIA，已过时）'},
    {
      'key': 'cuda-copy',
      'nameEn': 'CUDA (NVIDIA Only, Deprecated, Copy-Back)',
      'nameZh': 'CUDA（仅 NVIDIA，已过时，非直通）',
    },
    {'key': 'crystalhd', 'nameEn': 'CrystalHD (Deprecated)', 'nameZh': 'CrystalHD（全平台，已过时）'},
    {
      'key': 'rkmpp',
      'nameEn': 'Rockchip MPP (Selected Rockchip SoCs)',
      'nameZh': 'Rockchip MPP（仅部分 Rockchip 芯片）',
    },
  ];
  ...
  static const List<Map<String, String>> audioOutputDriversList = [
    ...
    {
      'key': 'jack',
      'nameEn': 'JACK (Linux / macOS, Low Latency)',
      'nameZh': 'JACK（Linux / macOS，低延迟音频）',
    },
    {
      'key': 'directsound',
      'nameEn': 'DirectSound (Windows Only)',
      'nameZh': 'DirectSound（仅 Windows）',
    },
  ...
  static const List<Map<String, String>> videoRenderersList = [
    ...
    {
      'key': 'mediacodec_embed',
      'nameEn': 'MediaCodec Embed (Android Only)',
      'nameZh': 'MediaCodec Embed（仅 Android）',
    },
    ...
    {
      'key': 'dmabuf-wayland',
      'nameEn': 'DMABUF Wayland (Linux Only)',
      'nameZh': 'DMABUF Wayland（仅 Linux）',
    },
    ...
    {
      'key': 'avfoundation',
      'nameEn': 'AVFoundation (macOS / iOS)',
      'nameZh': 'AVFoundation（macOS / iOS）',
    },
  ];
  ...
  static const List<Map<String, String>> mpvAnime4KShaders = [
    ...
    {
      'key': 'Anime4K_Restore_CNN_VL.glsl',
      'nameEn': 'CNN Restoration (VL)',
      'nameZh': 'CNN 图像恢复（高质量）',
    },
    {
      'key': 'Anime4K_Upscale_CNN_x2_VL.glsl',
      'nameEn': 'CNN 2× Upscaling (VL)',
      'nameZh': 'CNN 2 倍放大（高质量）',
    },
    {
      'key': 'Anime4K_AutoDownscalePre_x2.glsl',
      'nameEn': 'Auto Downscale Preprocess 2×',
      'nameZh': '2 倍自动预降采样',
    },
    {
      'key': 'Anime4K_AutoDownscalePre_x4.glsl',
      'nameEn': 'Auto Downscale Preprocess 4×',
      'nameZh': '4 倍自动预降采样',
    },
    {
      'key': 'Anime4K_Upscale_CNN_x2_M.glsl',
      'nameEn': 'CNN 2× Upscaling (Medium)',
      'nameZh': 'CNN 2 倍放大（中等）',
    },
  ];
  ...
  static const List<Map<String, String>> mpvAnime4KShadersLite = [
    {'key': 'Anime4K_Clamp_Highlights.glsl', 'nameEn': 'Clamp Highlights', 'nameZh': '高光限制'},
    {
      'key': 'Anime4K_Restore_CNN_M.glsl',
      'nameEn': 'CNN Restoration (Medium)',
      'nameZh': 'CNN 图像恢复（中等）',
    },
    {
      'key': 'Anime4K_Restore_CNN_S.glsl',
      'nameEn': 'CNN Restoration (Light)',
      'nameZh': 'CNN 图像恢复（轻量）',
    },
    {
      'key': 'Anime4K_Upscale_CNN_x2_M.glsl',
    ...
    {
      'key': 'Anime4K_Upscale_CNN_x2_S.glsl',
      'nameEn': 'CNN 2× Upscaling (Light)',
      'nameZh': 'CNN 2 倍放大（轻量）',
    },
  ];
  ...
  static List<String> get mpvAnime4KShaderKeys =>
      mpvAnime4KShaders.map((e) => e['key']!).toList(growable: false);
}
