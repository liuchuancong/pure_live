...
typedef JSTypedArrayBytesDeallocator = Void Function(Pointer bytes, Pointer deallocatorContext);
typedef JSTypedArrayBytesDeallocatorDart = void Function(Pointer bytes, Pointer deallocatorContext);
...
jSEvaluateScript = JscFfi.lib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Pointer, Pointer, Int32, Pointer)>>(
      'JSEvaluateScript',
    )
    .asFunction();
...
jSCheckScriptSyntax = JscFfi.lib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer, Pointer, Int32, Pointer<Pointer>)>>(
      'JSCheckScriptSyntax',
    )
    .asFunction();
