...
final Pointer Function(Pointer<Pointer> chars, Pointer numChars) jSStringCreateWithCharacters =
    JscFfi.lib
...
final Pointer Function(Pointer<Utf8> string) jSStringCreateWithUTF8CString = JscFfi.lib
    .lookup<NativeFunction<Pointer Function(Pointer<Utf8>)>>('JSStringCreateWithUTF8CString')
    .asFunction();
...
final Pointer<Utf16> Function(Pointer string) jSStringGetCharactersPtr = JscFfi.lib
...
final int Function(Pointer string) jSStringGetMaximumUTF8CStringSize = JscFfi.lib
    .lookup<NativeFunction<Uint32 Function(Pointer)>>('JSStringGetMaximumUTF8CStringSize')
    .asFunction();
...
final int Function(Pointer string, Pointer buffer, int bufferSize) jSStringGetUTF8CString = JscFfi
    .lib
    .lookup<NativeFunction<Uint32 Function(Pointer, Pointer, Uint32)>>('JSStringGetUTF8CString')
    .asFunction();
...
/// [@result] (bool) true if the two strings match, otherwise false.
final Pointer Function(Pointer a, Pointer b) jSStringIsEqualToUTF8CString = JscFfi.lib
    .lookup<NativeFunction<Pointer Function(Pointer, Pointer)>>('JSStringIsEqualToUTF8CString')
    .asFunction();
