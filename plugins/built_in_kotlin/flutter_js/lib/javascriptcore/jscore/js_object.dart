...
int jSClassAttributesToCEnum(JSClassAttributes type) {
  switch (type) {
    case JSClassAttributes.kJSClassAttributeNoAutomaticPrototype:
      return JSObjectRef.JSClassAttributes.kJSClassAttributeNoAutomaticPrototype;
    default:
...
extension JSStaticValueArray on List<JSStaticValue> {
  Pointer<JSObjectRef.JSStaticValue> createArray() {
    return JSObjectRef.JSStaticValuePointer.allocateArray(this.map((e) => e.toStruct()).toList());
  }
}
...
class JSStaticFunction {
  ...
  Pointer<NativeFunction<JSObjectRef.JSObjectCallAsFunctionCallback>>? callAsFunction;
...
class JSClassDefinition {
  ...
  /// The callback invoked when deleting a property.
  Pointer<NativeFunction<JSObjectRef.JSObjectDeletePropertyCallback>>? deleteProperty;

  /// The callback invoked when collecting the names of an object's properties.
  Pointer<NativeFunction<JSObjectRef.JSObjectGetPropertyNamesCallback>>? getPropertyNames;
  ...
  Pointer<NativeFunction<JSObjectRef.JSObjectConvertToTypeCallback>>? convertToType;
...
class JSObject {
  ...
  JSObject.make(this.context, JSClass jsClass, {Pointer? data})
    : this.pointer = JSObjectRef.jSObjectMake(context.pointer, jsClass.pointer, data ?? nullptr);
  ...
  JSObject.makeArray(this.context, JSValuePointer arguments, {JSValuePointer? exception})
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSObject.makeDate(this.context, JSValuePointer arguments, {JSValuePointer? exception})
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSObject.makeError(this.context, JSValuePointer arguments, {JSValuePointer? exception})
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSObject.makeRegExp(this.context, JSValuePointer arguments, {JSValuePointer? exception})
  ...
  JSObject.makeTypedArrayWithArrayBufferAndOffset(
    ...
    int length, {
    JSValuePointer? exception,
  }) : this.pointer = JSTypedArray.jSObjectMakeTypedArrayWithArrayBufferAndOffset(
         context.pointer,
         JSValue.jSTypedArrayTypeToCEnum(arrayType),
         buffer.pointer,
         byteOffset,
  ...
  JSValue get prototype {
    return JSValue(context, JSObjectRef.jSObjectGetPrototype(context.pointer, pointer));
  }
  ...
  bool hasProperty(String propertyName) {
    return JSObjectRef.jSObjectHasProperty(
          context.pointer,
          pointer,
  ...
  /// [propertyName] (JSStringRef) A JSString containing the property's name.
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSValue getProperty(String propertyName, {JSValuePointer? exception}) {
    return JSValue(
      context,
  ...
  bool deleteProperty(String propertyName, {JSValuePointer? exception}) {
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  bool hasPropertyForKey(String propertyKey, {JSValuePointer? exception}) {
  ...
  /// [propertyKey] A JSValueRef containing the property key to use when looking up the property.
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSValue getPropertyForKey(String propertyKey, {JSValuePointer? exception}) {
    return JSValue(
      context,
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSValue getPropertyAtIndex(int propertyIndex, {JSValuePointer? exception}) {
    return JSValue(
      context,
      JSObjectRef.jSObjectGetPropertyAtIndex(
        context.pointer,
        pointer,
        propertyIndex,
        (exception ?? JSValuePointer(nullptr)).pointer,
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  void setPropertyAtIndex(int propertyIndex, JSValue value, {JSValuePointer? exception}) {
  ...
  JSObject callAsConstructor(JSValuePointer arguments, {JSValuePointer? exception}) {
    return JSObject(
      context,
  ...
  JSPropertyNameArray copyPropertyNames() {
    return JSPropertyNameArray(JSObjectRef.jSObjectCopyPropertyNames(context.pointer, pointer));
  }
  ...
  void propertyNameAccumulatorAddName(JSPropertyNameAccumulator accumulator, String propertyName) {
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  Bytes typedArrayBytes({JSValuePointer? exception}) {
    return Bytes(
      JSTypedArray.jSObjectGetTypedArrayBytesPtr(
        context.pointer,
        pointer,
        (exception ?? JSValuePointer(nullptr)).pointer,
      ),
      JSTypedArray.jSObjectGetTypedArrayLength(
        context.pointer,
        pointer,
        (exception ?? JSValuePointer(nullptr)).pointer,
      ),
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  int typedArrayByteLength({JSValuePointer? exception}) {
    return JSTypedArray.jSObjectGetTypedArrayByteLength(
      context.pointer,
      pointer,
      (exception ?? JSValuePointer(nullptr)).pointer,
    );
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  int typedArrayByteOffset({JSValuePointer? exception}) {
    return JSTypedArray.jSObjectGetTypedArrayByteOffset(
      context.pointer,
      pointer,
      (exception ?? JSValuePointer(nullptr)).pointer,
    );
  ...
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  JSObject typedArrayBuffer({JSValuePointer? exception}) {
    return JSObject(
      context,
      JSTypedArray.jSObjectGetTypedArrayBuffer(
        context.pointer,
        pointer,
        (exception ?? JSValuePointer(nullptr)).pointer,
      ),
  ...
  /// The pointer returned by this function is temporary and is not guaranteed to remain valid across JavaScriptCore API calls.
  /// [exception] (JSValueRef*) A pointer to a JSValueRef in which to store an exception, if any. Pass NULL if you do not care to store an exception.
  Bytes arrayBufferBytes({JSValuePointer? exception}) {
    return Bytes(
      JSTypedArray.jSObjectGetArrayBufferBytesPtr(
        context.pointer,
        pointer,
        (exception ?? JSValuePointer(nullptr)).pointer,
      ),
      JSTypedArray.jSObjectGetArrayBufferByteLength(
        context.pointer,
        pointer,
        (exception ?? JSValuePointer(nullptr)).pointer,
      ),
...
class JSObjectPointer {
  ...
  JSObjectPointer([Pointer? value]) : this.count = 1, this.pointer = malloc.call<Pointer>(1) {
