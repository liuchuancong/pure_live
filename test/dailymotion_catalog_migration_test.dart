...
void main() {
  ...
  test('catalog twenty-eight adds Dailymotion once and preserves a later hide', () async {
    ...
    expect(favorites.hotAreasList, [Sites.huyaSite, Sites.nimoTvSite, Sites.dailymotionSite]);
    expect(favorites.siteCatalogMigration.value, 28);
    ...
    expect(reopened.hotAreasList, [Sites.huyaSite, Sites.nimoTvSite]);
    expect(reopened.siteCatalogMigration.value, 28);
  });
}
