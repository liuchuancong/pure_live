...
void main() {
  ...
  test('catalog thirty-four adds Taobao Live once and preserves a later hide', () async {
    ...
    final expectedPrefix = [Sites.huyaSite, Sites.jdLiveSite, Sites.taobaoLiveSite];
    ...
    expect(reopened.hotAreasList, migrated.where((id) => id != Sites.taobaoLiveSite).toList(growable: false));
