...
void main() {
  ...
  setUpAll(() async {
    folder = await Directory.systemTemp.createTemp('shopeelive-catalog-');
  ...
  test('catalog twenty-five adds Shopee Live once and preserves a later hide', () async {
    ...
    final expectedPrefix = [Sites.huyaSite, Sites.popkonSite, Sites.shopeeLiveSite];
    ...
    expect(reopened.hotAreasList, migrated.where((id) => id != Sites.shopeeLiveSite).toList(growable: false));
