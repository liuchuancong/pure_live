...
- **最新稳定版**：[v3.2.6](https://github.com/wzgrx/pure_live/releases/tag/v3.2.6)，从维护分支 `claude` 发布，更新内容见[版本说明](RELEASE_NOTES.md)。
...
- **当前源码版本号**：`3.2.6+4129`。候选包按源码 SHA 与验证记录识别，同一版本号不代表包含相同修订。
