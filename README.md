...
- **最新稳定版**：[v2.0.32](https://github.com/wzgrx/pure_live/releases/tag/v2.0.32)
- **当前版本**：`2.0.32+43`（`master`）
...
- **弹幕增强**：顶部约 20% 的最佳观看模板、舒适/高密度模板、过滤、用户/关键词屏蔽、描边、透明度、字号、速度、显示区域，以及动态跟随屏幕最高刷新率；直播间内调整即时作用于画面。
