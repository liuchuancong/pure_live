...
- **源码平台范围**：目前 42 个直播站点 + IPTV，共 43 个适配器；注册不等于目录、搜索、播放、弹幕和录制均已完整验收，能力边界见[平台兼容性](docs/PLATFORM_COMPATIBILITY.md)。
...
- 粉丝数量
- 直播状态筛选
- YY、LiveMe、TikTok LIVE、YouTube Live、Bigo Live、PandaTV、PopkonTV、Shopee Live、VK Video Live、NimoTV、Dailymotion、Rumble、GoodGame、FC2 Live、Steam Broadcasts、京东直播、淘宝直播、酷狗直播等平台原生/本机搜索，快手保留网页搜索
- Bilibili、斗鱼、虎牙、抖音、快手、网易 CC、Twitch、SOOP、YY、AcFun、Picarto、TwitCasting、SHOWROOM、CHZZK、Kick、17LIVE、LiveMe、TikTok LIVE、YouTube Live、Bigo Live、PandaTV、PopkonTV、Shopee Live、VK Video Live、NimoTV、Dailymotion、Rumble、GoodGame、FC2 Live、Steam Broadcasts、京东直播、淘宝直播、酷狗直播网页直播间识别
...
mellow-fan（OPENREC）、FLEX TV（TTingLive）、CHZZK、Kick、17LIVE、LiveMe、TikTok LIVE、YouTube Live、Bigo Live、PandaTV、PopkonTV、Shopee Live、VK Video Live、NimoTV、Rumble、GoodGame、FC2 Live、Steam Broadcasts 和酷狗直播可以显示平台明确返回的并发人数。

设置页会列出全部 42 个普通直播平台。虎牙、Bilibili、斗鱼、Dailymotion、京东直播、淘宝直播等平台按照公开数据实际提供的热度、
