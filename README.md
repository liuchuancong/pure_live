...
- **最新稳定版**：[v2.9.6](https://github.com/liuchuancong/pure_live/releases/tag/v2.9.6)
- **当前版本**：`2.9.6+4085`
- **v2.9.6**：`liuchuancong/pure_live@974f4c32`；具体合并与验证证据见 `docs/STAGE_UPDATE_2_9_6.md`
- **本轮构建平台**：Android arm64-v8a (Windows/Linux/macOS/iOS remain at v2.9.6)
- **质量门禁**：Flutter Analyze、自动化测试、40 项接口探测与 Android 构建记录见 `docs/STAGE_UPDATE_2_9_6.md`
