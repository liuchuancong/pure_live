...
- **最新稳定版**：[v3.1.1](https://github.com/wzgrx/pure_live/releases/tag/v3.1.1)
- **当前 Android / Windows 构建版本**：`3.1.1+4114`（修复多画面所有布局的音量入口、声音来源同步、弹幕目标与按房间音量持久化；Android arm64-v8a 与 Windows x64 从同一提交串行构建）
