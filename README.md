...
- **最新稳定版**：[v3.0.11](https://github.com/wzgrx/pure_live/releases/tag/v3.0.11)
- **当前 Android 构建版本**：`3.0.11+4099`（共享播放器比例污染回滚、全屏局部竖屏视口与跨模式隔离）
...
- **质量门禁**：共享播放器 fit 隔离、全屏视频/控件边界、普通页、小窗与 PiP 回归见 `docs/STAGE_UPDATE_3_0_11.md`
