...
- **最新稳定版**：[v3.0.10](https://github.com/wzgrx/pure_live/releases/tag/v3.0.10)
- **当前 Android 构建版本**：`3.0.10+4098`（横屏全屏竖屏画面居中、透明播放器表面与两侧模糊背景修复）
...
- **质量门禁**：横屏全屏 contain、透明表面、背景回退、跨平台竖屏识别与既有四种呈现回归见 `docs/STAGE_UPDATE_3_0_10.md`
...
| [v3.0.10 Android 横屏全屏竖屏展示修复](docs/STAGE_UPDATE_3_0_10.md) | 全屏 contain、透明原生表面、模糊背景回退与跨平台识别边界 |
